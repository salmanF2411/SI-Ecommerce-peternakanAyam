...
@media print {
    ...
    .modal-close-btn, .order-modal-footer {
                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;flex-direction:column;gap:2px">
                            <b style="font-size:13px"><?= e($order['customer_name'] ?: ($order['name'] ?? 'Pelanggan')) ?></b>
                            <small style="color:var(--muted)"><?= e($order['customer_phone'] ?: ($order['phone'] ?? '-')) ?></small>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="order-action-group">
                            <button type="button" class="btn-detail" onclick="openOrderDetail(<?= (int)$order['id'] ?>)" title="Lihat Rincian Pesanan">
    ...
    <div class="order-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="modalOrderCode">
        ...
        <div class="order-modal-header">
            ...
            <div style="display:flex;align-items:center;gap:12px">
                ...
                <button type="button" class="modal-close-btn" onclick="closeOrderDetailModal()" aria-label="Tutup popup" title="Tutup">
                    &times;
                </button>
            </div>
        </div>
                    ...
                    <table class="modal-product-table">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td id="modalTableTotal" style="text-align:right;font-weight:800;color:#2f5d3a;font-size:16px">Rp 0</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>

    ...
    <div class="panel">
        ...
        <form class="product-form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="name" value="<?= e($editProduct['name'] ?? '') ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="number" name="stock" min="0" value="<?= $editProduct['stock'] ?? 0 ?>"
                    required>
            </div>
            ...
            <div class="form-group full">
                ...
                <textarea class="form-control" name="description" rows="4"
                    required><?= e($editProduct['description'] ?? '') ?></textarea>
            </div>
            ...
            <div class="form-group full">
                ...
                <?php if (!empty($editProduct['image'])): ?>
                    ...
                    <div id="current-image-wrap" style="margin-bottom:12px">
                        ...
                        <img id="current-preview" src="<?= e(productImage($editProduct['image'])) ?>" alt="Foto produk saat ini"
                ...
                <div style="border:2px dashed var(--line);border-radius:var(--radius);padding:20px;text-align:center;background:var(--surface);position:relative;cursor:pointer"
                    id="upload-drop-zone" onclick="document.getElementById('product-image-file').click()">
                    <input type="file" id="product-image-file" name="image_file" accept="image/jpeg,image/png,image/webp"
                        style="display:none">
                    <div id="upload-placeholder">
                        <i class="fa fa-cloud-upload"
                            style="font-size:28px;color:var(--muted);margin-bottom:8px;display:block"></i>
                    ...
                    <div id="upload-preview-wrap" style="display:none">
                        ...
                        <button type="button" id="btn-remove-image" onclick="event.stopPropagation();removeImagePreview()"
    ...
    <div class="table-wrap">
        <table class="data-table">
            ...
            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <form method="post" style="display:inline">
                                        ...
                                        <button class="btn btn-sm" style="background:var(--green);color:#fff;border:none"
                                            type="submit" data-confirm="Aktifkan kembali produk '<?= e($item['name']) ?>'?">
                ...
                <?php if (!$products): ?>
                    <tr>
                        <td colspan="8" class="text-center text-muted" style="padding:32px">Belum ada produk</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
